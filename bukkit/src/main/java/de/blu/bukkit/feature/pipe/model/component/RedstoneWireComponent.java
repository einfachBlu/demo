...
public final class RedstoneWireComponent extends PipeComponent {
  ...
  private static final List<BlockFace> AROUND_ALLOWED_FACES = List.of(BlockFace.NORTH, BlockFace.EAST, BlockFace.SOUTH,
      BlockFace.WEST);

  public RedstoneWireComponent(Block block) {
    super(block);
  }

  @Override
  public PipeComponentType getType() {
    return PipeComponentType.REDSTONE_WIRE;
  }
